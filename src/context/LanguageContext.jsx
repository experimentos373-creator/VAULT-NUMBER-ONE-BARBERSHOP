...
const TRANSLATIONS = {
  pt: {
    ...
    "form.budget.bike": "Serviços Pretendidos (ex: Corte + Barba)",
    ...
    "form.workshop.bike": "Estilo / Pedido especial",
  ...
  en: {
    ...
    "form.budget.bike": "Desired Services (e.g. Cut + Beard)",
    ...
    "form.workshop.bike": "Desired style / Special requests",
