...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50 transition-all duration-300">
      {/* Announcement Bar */}
      <div className="bg-neutral-950 text-white text-[9px] font-extrabold tracking-widest uppercase py-2 text-center border-b border-neutral-900">
        {language === "en" 
        ...
        <div className="max-w-[1400px] mx-auto px-6 flex justify-between items-center">
          ...
          <Link to={prefix || "/"} className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3 group">
            <div className="flex items-center gap-2">
              ...
              <span className="font-extrabold tracking-tighter text-xl font-display text-black">
                AGOSTINHO<span className="text-primary font-black">.IN</span>
              </span>
            </div>
