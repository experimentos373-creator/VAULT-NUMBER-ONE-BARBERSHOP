  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 w-full relative z-10 py-12 flex flex-col items-start justify-center">
        {/* Rating and Badges */}
        <div className="inline-flex items-center gap-2 bg-[#0A0A0A]/95 border border-neutral-800 px-4 py-2 text-xs font-semibold text-neutral-205 mb-6 shadow-sm rounded-full backdrop-blur-sm reveal-slide-up">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tighter leading-[0.95] font-display text-white mb-6 uppercase max-w-4xl reveal-slide-up">
          {t("hero.title1")} <br />
        ...
        <p className="text-base sm:text-lg md:text-xl text-neutral-300 font-normal max-w-xl mb-10 leading-relaxed reveal-slide-up">
          {t("hero.subtitle")}
        </p>
